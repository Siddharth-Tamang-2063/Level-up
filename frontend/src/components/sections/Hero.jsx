...
const SLIDES = [
  {
    ...
    line1: 'Style',
    line2: 'that Lasts',
    sub: 'Delivered across Nepal · Cash on Delivery',
    cta: 'Shop Now',
    ctaLink: '/collection?collection=ss25',
    accent: '#BF7B16',
  },
  {
    image: 'https://images.unsplash.com/photo-1558769132-cb1aea458c5e?w=1600&q=90',
    tag: 'Everyday Essentials',
    line1: 'Simple &',
    line2: 'Honest',
    sub: 'Good quality basics at fair prices',
    cta: 'Shop Basics',
    ctaLink: '/collection?collection=essentials',
    accent: '#185C3E',
  },
  {
    ...
    line1: 'Built for',
    line2: 'Nepal',
    sub: 'From Kathmandu to the hills',
    cta: 'Shop Jackets',
    ctaLink: '/collection?collection=outerwear',
    accent: '#8C1B35',
  },
]
