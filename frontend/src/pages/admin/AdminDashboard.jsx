              ...
              {PRODUCTS.slice(0, 5).map((p, i) => (
                <div key={p.id} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-charcoal/40 font-sans">Rs. {p.price}</p>
                  </div>
                ...
                {ORDERS.slice(0, 5).map(order => (
                  <tr key={order.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      ...
                      <p className="text-xs text-charcoal/60 font-sans">{order.email}</p>
                    </td>
                    <td className="px-6 py-4 text-sm font-sans text-charcoal/60">{order.date}</td>
                    <td className="px-6 py-4 text-sm font-sans font-medium text-charcoal">Rs. {order.total.toLocaleString()}</td>
                    <td className="px-6 py-4">
