            ...
            {selected ? (
              <div className="h-full flex flex-col">
                ...
                {replySent[selected.id] ? (
                  ...
                  <div>
                    <p className="text-xs tracking-widest uppercase font-sans font-medium text-charcoal/40 mb-3">Reply</p>
                    <textarea
                      value={replyText}
              ...
              <div className="h-full flex items-center justify-center text-center">
                <div>
                  <MailOpen size={40} className="text-charcoal/20 mx-auto mb-4" />
